...
# (project=scitex-session, owner=ywatanabe1989, repo=scitex-session,
...
TMPDIR="/tmp/publish-scitex_session-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-session dist/* uploaded to PyPI via manual OIDC trusted publishing"
